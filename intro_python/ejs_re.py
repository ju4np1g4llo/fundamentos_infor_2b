...
def entre_guiones(string):
    return re.findall(r"-(.*?)-", string) #el ? favorece los matches internos, el * dice que aparezca 0 o mas veces
...
# r"-([\w+_-]@[\w+]\.[a-z]{2-6})-"     patron que puede buscar mails
# esta entre parentesis para buscar un mail que este entre guiones            
##### **Ejercicio 11**
